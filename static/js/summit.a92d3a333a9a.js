 ...
 jQuery(document).ready(function($) {
     ...
     // jQuery('.image-slide').on('beforeChange', function(event, slick, currentSlide, nextSlide) {
         // console.log(nextSlide);
         // const currentSlideNum = nextSlide + 1;
         // jQuery('.tab-slide-item').removeClass('active');
         // jQuery('.tab-slide-item:nth-child(' + currentSlideNum + ')').addClass('active');
     // });

     // jQuery('.tab-slide-item').click(function() {
     //     jQuery('.tab-slide-item').removeClass('active');
     //     jQuery(this).addClass('active');
     //     var num = parseInt(jQuery(this).attr("num"));
         // jQuery('.content-slide').slick('slickGoTo', num);
     // });
